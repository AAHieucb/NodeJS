    ...
    try {
        ...
        if (data) {
            ...
            if(response){
                ...
                // Hàm setEx (atomic) thì key vẫn là đối dố 1, value là đối số thứ 3, nhưng thêm đối số 2 là timeout. Redis sẽ lưu cặp key value này trong khoảng giá trị timeout r tự bị xóa. 
