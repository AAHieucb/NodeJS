...
// 1 là tên case trong test suite, 2 là hàm số chạy test; Còn expect(<hàm gì>)(.not).toBe(<kết quả mong muốn đầu ra>)
...
// Nếu chỉ muốn chạy 1 cái gì đó thì thêm .only vào -> nếu có nh .only sẽ chạy tất cả các hàm có only. Nếu dùng only sẽ k có cách nào chạy các hàm k có only
