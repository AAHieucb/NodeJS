...
// Khi dùng fork nó sẽ thiết lập kênh IPC(Inter-process communication). Từ đó ta có thể dùng process.send để gửi từ process con sang cha. Fork chính là Th đặc biệt của spawn chỉ dùng cho chạy tiến trình khác ở file khác này