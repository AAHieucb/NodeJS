...
(async () => {
    const client = redis.createClient(6379); // Mặc định redis chạy trên port 6379
    ...
    const data = await client.setNX("test", "Fun"); // Trả ra true or false, có set được hay k. setNX là async, setX là sync
    console.log(data);
